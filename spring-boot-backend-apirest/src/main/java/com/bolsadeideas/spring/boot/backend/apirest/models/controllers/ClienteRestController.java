...
@CrossOrigin(origins= {"http://localhost:4200","*" }) // en el * va la IP de produccion
@RestController
@RequestMapping("/api")
...
//	}
	...
	@Secured("ROLE_ADMIN") // Ó => @Secured({"ROLE_ADMIN"})
	@PostMapping("/clientes")
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		log.info("cliente a crear: "+cliente.toString());
...
//	}
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		clienteService.delete(id); 
			...
			response.put("mensaje", "Error al eliminar el actualizar en la base de datos");
			response.put("error", e.getMessage().concat(": ").concat(e.getMostSpecificCause().getMessage()));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public List<Region> listarRegiones() {
		log.info("REGIONES1: "+clienteService.findAllRegiones());
